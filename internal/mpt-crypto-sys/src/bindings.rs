...
pub const ttCONFIDENTIAL_MPT_CONVERT: u32 = 85;
pub const ttCONFIDENTIAL_MPT_MERGE_INBOX: u32 = 86;
pub const ttCONFIDENTIAL_MPT_CONVERT_BACK: u32 = 87;
pub const ttCONFIDENTIAL_MPT_SEND: u32 = 88;
pub const ttCONFIDENTIAL_MPT_CLAWBACK: u32 = 89;
...
unsafe extern "C" {
    #[doc = " @brief Verifies the link proof between ElGamal and Pedersen commitments.\n * @return 1 if the proof is valid, 0 otherwise."]
    pub fn secp256k1_elgamal_pedersen_link_verify(
        ctx: *const secp256k1_context,
        proof: *const ::std::os::raw::c_uchar,
        c1: *const secp256k1_pubkey,
        c2: *const secp256k1_pubkey,
...
unsafe extern "C" {
    #[doc = " Returns the size of the serialized proof for N recipients.\n Size: (1 + N) * 33 bytes for points + 2 * 32 bytes for scalars."]
    pub fn secp256k1_mpt_proof_equality_shared_r_size(n: usize) -> usize;
}
unsafe extern "C" {
    #[doc = " Generates a proof that multiple ciphertexts encrypt the same amount m\n using the SAME shared randomness r."]
    pub fn secp256k1_mpt_prove_equality_shared_r(
        ctx: *const secp256k1_context,
        proof_out: *mut ::std::os::raw::c_uchar,
        amount: u64,
...
unsafe extern "C" {
    #[doc = " Verifies the proof of equality with shared randomness."]
    pub fn secp256k1_mpt_verify_equality_shared_r(
        ctx: *const secp256k1_context,
        proof: *const ::std::os::raw::c_uchar,
        n: usize,
        C1: *const secp256k1_pubkey,
