...
//
// VaultClawback requires an XLS-65-enabled xrpld node. These tests validate
...
use xrpl::models::{IssuedCurrencyAmount, Model};
...
fn test_vault_clawback_serde_roundtrip() {
    let vault_clawback = VaultClawback {
        ...
        amount: Some(
            IssuedCurrencyAmount::new("USD".into(), "rIssuer123".into(), "500".into()).into(),
        ),
    };
...
fn test_vault_clawback_builder_pattern() {
    ...
    let vault_clawback = VaultClawback {
        ...
        holder: "rTarget".into(),
        amount: Some(
            IssuedCurrencyAmount::new("USD".into(), "rClawBuilder".into(), "1000".into()).into(),
        ),
    }
    .with_fee("12".into())
    .with_sequence(600)
